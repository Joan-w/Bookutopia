function Order(number, book) {
  ...
  $(document).ready(function () {
    $("#grade1Cre").click(function () {
      ...
      var inputtedNumber = parseInt($(".quantity7").val());;
    ...
    $("#grade1Environ").click(function () {
      var inputtedNumber =parseInt($(".quantity1").val());
    ...
    $("#grade1Mvmnt").click(function () {
      var inputtedNumber = parseInt($(".quantity5").val());
    ...
    $("#grade1Maths").click(function () {
      var inputtedNumber = parseInt($(".quantity4").val());
    ...
    $("#grade1Kisw").click(function () {
      var inputtedNumber = parseInt($(".quantity3").val());
    ...
    $("#grade1Hygiene").click(function () {
      var inputtedNumber = parseInt($(".quantity2").val());
    ...
    $("#grade2Cre").click(function () {
      var inputtedNumber = parseInt($(".quantity6").val());
    ...
    $("#grade2Eng").click(function () {
      var inputtedNumber = parseInt($(".quantity8").val());
    ...
    $("#grade2Environ").click(function () {
      var inputtedNumber = parseInt($(".quantity9").val());
...
order.addEventListener("click", function(){
    ...
    var totalAmount = theTotal+1000;

    alert(`The total amount of your order is Kshs. ${theTotal}`);
    prompt(`Do you want your order delivered? If no cancel, if yes, please type in your location....`);
    alert(`Ensure you have Ksh. 1000 for delivery. Thank you for placing an order. The total amount delivery fees inclusive is Kshs. ${totalAmount}`)            
